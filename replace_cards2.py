...
# We want to replace the block starting with <div class="why-grid"> 
# and ending at the </div> that comes right before </div>\n    </section>\n\n\n\n\n\n\n    <!-- ======================================================\n       PREVIOUS EVENT SHOWCASE
# Instead, let's use a regex to match from <div class="why-grid"> to <!-- Card 6 --> and its closing tags.

pattern = r'<div class="why-grid">.*<!-- Card 6 -->.*?</div>\s*</div>\s*</div>'
